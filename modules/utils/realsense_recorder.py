...
class RealSenseRecorder:
    ...
    def __init__(
        self,
        output_dir: str = "datasets/lab_scene",
        width: int = 640,
        height: int = 480,
        max_frames: int = 50,
        fps: int = 30,
        ...
        self.depth_png_dir = self.output_dir / "depth_png"
    ...
    def _save_intrinsics(self) -> None:
        ...
        print(f"[✓] Intrinsics saved to: {self.intrinsics_file}")
    ...
    def capture(self) -> None:
        ...
        try:
            ...
            print(f"[✓] Capture finished: {frame_count} frames saved.")
